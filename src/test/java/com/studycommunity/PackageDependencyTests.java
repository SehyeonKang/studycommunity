...
@AnalyzeClasses(packagesOf = StudyCommunityApplication.class)
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.studycommunity.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.studycommunity.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.studycommunity.modules.(*)..")
